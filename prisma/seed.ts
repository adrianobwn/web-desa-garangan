...
<p>Kepala Desa Garangan menyampaikan bahwa demplot serupa akan diperluas ke Dusun Losari dan Dusun Ngasinan pada musim tanam berikutnya, dengan target tambahan 12 hektar lahan.</p>`,
  ...
  await prisma.statistik.upsert({
    ...
    create: {
      ...
      luasWilayahHa: 881,
      perDusun: [
        { label: "Garangan", jiwa: 1253, kk: 412 },
        { label: "Dusun I — Losari", jiwa: 965, kk: 318 },
        { label: "Dusun II — Sokokerep", jiwa: 532, kk: 176 },
        { label: "Dusun III — Getas Krikil", jiwa: 718, kk: 236 },
        { label: "Dusun IV — Ngasinan", jiwa: 744, kk: 244 },
      ],
      mataPencaharian: [
  ...
  await prisma.perangkatDesa.createMany({
    data: [
      ...
      { nama: "Kamsudin", jabatan: "Kadus I · Losari", tingkat: 3, urutan: 0 },
      { nama: "Handogo", jabatan: "Kadus II · Sokokerep", tingkat: 3, urutan: 1 },
      { nama: "Ngatiri", jabatan: "Kadus III · Getas Krikil", tingkat: 3, urutan: 2 },
      { nama: "Kartono", jabatan: "Kadus IV · Ngasinan", tingkat: 3, urutan: 3 },
